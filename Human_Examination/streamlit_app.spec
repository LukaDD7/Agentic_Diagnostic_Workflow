...
# Streamlit 应用主文件名
streamlit_app_main_file = "examination_app.py"
entry_point_script = "run_streamlit.py"
...
a = Analysis(
    ...
    datas=[
        ...
        ("data/AGAP_fullset_filtered.csv", "data"),
...
exe = EXE(
    ...
    a.datas,
    [],
    name='streamlit_app', # The name of your .exe file
